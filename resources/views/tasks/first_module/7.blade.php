                ...
                <div class="task-page">
                    ...
                    <div class="task-content">
                        <div class="task-description">
                            ...
                            <p>Для измерения какой физической величины используют указанное лабораторное оборудование? Отметь его название.</p>
                        </div>
                        <div class="image__container">
                            <img src="{{ asset('images\tasks\mins.jpg') }}" alt="Task Image">
                        </div>
                        <div class="task-answers">
                            <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                                ...
                                <div class="answer-block">
                                    ...
                                    <select name="answers[]" class="select-answer" required>
                                        <option value="объема">Объема</option>
                                        <option value="силы">Силы</option>
                                        <option value="напряжения">Напряжения</option>
                                        <option value="массы">Массы</option>
                                    </select>
                                </div>
                                @if(session('success'))
                            ...
                            <div class="task-actions">
                                ...
                                @endif
                                @if($nextTask)
                                    <a href="{{ route('tasks.show', $nextTask) }}" class="btn btn-next mod">Следующее задание →</a>
                                @endif
                            </div>
                            @auth
