            ...
            <div class="wrapper">
                ...
                <div class="task-content">
                    <div class="task-description">
                        ...
                        <p>Укажи верное утверждение о принципе суперпозиции сил:</p>
                    </div>
                    <div class="task-answers">
                        <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                            @csrf
                            <div class="answer-options">
                                @foreach(['скалярная запись принципа суперпозиции позволяет определить только направление равнодействующей всех сил, приложенных к материальной точке', 
                                'принцип суперпозиции справедлив только для сил одной физической природы', 
                                'принцип суперпозиции верен для сил любой физической природы'] as $option)
