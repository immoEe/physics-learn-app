                            ...
                            <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                                ...
                                <div class="motion-selects">
                                    <div class="motion-item">
                                        <label>1. Движение тела, поднимающегося на эскалаторе —</label>
                                        <select name="answers[]" class="answer-select" required>
                                            <option value="" disabled selected>Выберите тип</option>
                                            <option value="поступательное">Поступательное</option>
                                            <option value="вращение">Вращение</option>
                                            <option value="колебания">Колебания</option>
                                        </select>
                                    </div>
                                    <div class="motion-item">
                                        <label>2. Движение кабины канатной дороги —</label>
                                        <select name="answers[]" class="answer-select" required>
                                            <option value="" disabled selected>Выберите тип</option>
                                            <option value="поступательное">Поступательное</option>
                                            <option value="вращение">Вращение</option>
                                    ...
                                    <div class="motion-item">
                                        <label>3. Движение лопастей вентилятора —</label>
                                        <select name="answers[]" class="answer-select" required>
                                            <option value="" disabled selected>Выберите тип</option>
                                            <option value="поступательное">Поступательное</option>
                                            <option value="вращение">Вращение</option>
