                            ...
                            <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                                ...
                                <div class="answer-options">
                                    <label class="option-item">
                                        <input type="radio" name="answers[]" value="световые">
                                        <span>Световые</span>
                                    </label>
                                    <label class="option-item">
                                        <input type="radio" name="answers[]" value="звуковые">
                                        <span>Звуковые</span>
                                    </label>
                                    <label class="option-item">
                                        <input type="radio" name="answers[]" value="электрические">
                                        <span>Электрические</span>
                                    </label>
                                    <label class="option-item">
                                        <input type="radio" name="answers[]" value="тепловые">
                                        <span>Тепловые</span>
                                    </label>
                                    <label class="option-item">
                                        <input type="radio" name="answers[]" value="магнитные">
                                        <span>Магнитные</span>
                                    </label>
                                    <label class="option-item">
