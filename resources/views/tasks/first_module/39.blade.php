                        ...
                        <div class="task-answers">
                            <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                                ...
                                <div class="answer-block">
                                    <p>1) модуль скорости точки равен (округли до десятых) 
                                        <input 
                                            type="number" 
                                            name="speed"
                                            class="answers[]"
                                    ...
                                    <p>2) точка движется 
                                        <select name="answers[]" class="answer-select" required>
                                            ...
                                            <option value="positive">в положительном направлении оси X</option>
                                            <option value="negative">противоположно положительному направлению оси X</option>
                                        </select>
                                    </p>
                                </div>
