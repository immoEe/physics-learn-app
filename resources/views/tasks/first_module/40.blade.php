                    ...
                    <div class="task-content">
                        <div class="task-description">
                            ...
                            <div class="graph-container">
                                <img src="{{asset('images/tasks/40.jpg')}}" alt="График s(t)" class="task-graph">
                                <p class="graph-caption">График</p>
                            </div>
                        </div>
                                ...
                                <div class="answer-block">
                                    <p>Ответы: 
                                        <input 
                                            ...
                                            class="answers[]"
                                            step="0.1"
                                            placeholder="Модуль перемещения"
                                            required
                                            autocomplete="off"
                                        >
                                        <input 
                                            ...
                                            class="answers[]"
                                            step="0.1"
                                            placeholder="Средняя путевая скорость"
                                            required
                                            autocomplete="off"
                                        >
                                    </p>
