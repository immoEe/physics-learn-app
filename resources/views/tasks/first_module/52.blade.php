                            ...
                            <form id="task-form" method="POST" action="{{ route('tasks.check', $task) }}">
                                ...
                                <div class="answer-block">
                                    <input 
                                        ...
                                        autocomplete="off"
                                    >
                                    <span>закон Ньютона гласит: существуют системы отсчёта, называемые инерциальными, в которых тело движется по инерции, пока результирующая приложенных к нему сил со стороны других тел равна нулю, или пока действие сил со стороны других тел отсутствует.</span>
                                </div>
